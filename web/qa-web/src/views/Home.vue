      ...
      <div class="hero-content">
        ...
        <div class="hero-features">
          <div class="feature-item">
            ...
            <span>{{ t('home.hero.features.professionalTeam') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.hero.features.realTimeConsultation') }}</span>
          </div>
          <div class="feature-item">
            <CheckCircleOutlined class="feature-icon" />
            <span>{{ t('home.hero.features.privacyProtection') }}</span>
          </div>
        </div>
        <div class="hero-actions">
          <a-button type="primary" size="large" @click="navigateTo('/consultation')">
            {{ t('home.hero.actions.startConsultation') }}
          </a-button>
    ...
    <section class="statistics">
      ...
      <div class="stat-card">
        ...
        <div class="stat-info">
          ...
          <p>{{ t('home.statistics.pendingResponses') }}</p>
        </div>
      </div>
      <div class="stat-card">
